...
For this demo, I'll use OpenAI's [gpt-5-mini model](https://github.com/marketplace/models/azure-openai/gpt-5-mini). Either scroll down to find it, or set the *Publishler* drop-down to **Azure OpenAI Service**

![](../images/agent-framework-gh-models-1.jpg)
...
![](../images/agent-framework-gh-models-2.jpg)
...
![](../images/agent-framework-gh-models-3.jpg)
...
![](../images/agent-framework-gh-models-4.jpg)
...
From there, we can create our AI Agent with it's name and instructions, and then use our OpenTelemetry configuration to configure instrumentation for our agent.

```csharp
AIAgent agent = new ChatClient(model, new ApiKeyCredential(githubPAT), openAIOptions)
                    .CreateAIAgent(instructions: "You are an fitness expert", name: "GymBrah")
                    .AsBuilder()
...
Bear in mind that at the time of writing this blog (9th January 2026), the Microsoft Agent Framework is in preview, so expect API's to change!
